...
from plugins.SAC_n_layers.buffer import ReplayBuffer
from plugins.SAC_n_layers.actor_critic import Actor, CriticQ, CriticV
...
class SAC:
    def __init__(self, action_dim, state_dim, model_path, alpha = LR_A, beta = LR_Q, gamma = GAMMA, tau = TAU,
        ...
        self.qf1 = CriticQ(self.statedim + self.actiondim, NETWORK_STRUCTURE).to(self.device)
        self.qf2 = CriticQ(self.statedim + self.actiondim, NETWORK_STRUCTURE).to(self.device)
